...
than undetected, flagged by the invariant check. \textbf{Fifth, the spend policy is a redundant layer
...
\texttt{detection\_source:\ invariant\_check}: the invariant check flags both admitted effects. The
