...
the \emph{misbehavior rate}, because the distance between the two is the entire contribution.
...
NVIDIA's \texttt{nemotron-3-super-120b-a12b} via the official NVIDIA endpoints. The 57/73 misbehavior
rate is a property of \emph{that} model at \emph{that} version; a different or more heavily-guarded base
...
\item
  ...
  Agents on the BEAM.} Manuscript dated 29 July 2026; archival identifier pending.
  Source in the artifact repository at
