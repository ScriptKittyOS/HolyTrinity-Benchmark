...
and `../artifacts/`); we withhold only the fixtures — and the definition files — for the
...
signatures: their fixtures are payload mutations, approval-lifecycle states, and process
events, published with their family definitions.
